    ...
    <nav className="bg-gray-800 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:block sm:ml-6">
              <div className="flex space-x-4">
                <Link
                  className="text-gray-200 hover:bg-orange-500 focus:bg-orange-500 hover:text-white px-3 py-2 rounded-md text-md font-bold"
                  to="/"
                >
                  Home
                </Link>
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <Link
              to="/signin"
              className="text-gray-200 border border-orange-500 hover:bg-orange-500 hover:text-white px-3 py-2 rounded-md text-md font-bold"
            >
              Sign in
            </Link>
          </div>
      ...
      <div className="hidden" id="toogleDiv">
        <div className="px-2 pt-2 pb-3 space-y-1">
          <Link
            to="/"
            className="text-gray-200 hover:bg-orange-500 focus:bg-orange-500 hover:text-white block px-3 py-2 rounded-md text-base font-bold"
          >
            Home
          </Link>
          <Link
